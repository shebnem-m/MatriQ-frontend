...
export default function SupplierVerificationTable({ suppliers }) {
    ...
    <div className="bg-chalk text-ink font-body">
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-rust text-chalk rounded-sm font-medium text-sm hover:bg-rust/90">
